...
The pharmacy crosswalk tabs below map the **BPS pharmacy module v0.2.0**, a **draft** module that is **not yet wired into the core schema** (it targets core **v1.2.0**). The tabs may not appear in the Live Crosswalk Matrix above until the corresponding tabs are created in the source Sheet. Treat this section as a preview of the planned pharmacy crosswalk.
:::
